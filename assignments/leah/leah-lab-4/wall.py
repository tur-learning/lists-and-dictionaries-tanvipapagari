...
def position_overlaps_with_corners(pos):
    return any(pos in corner for corner in corners)
...
def generate_corner(x,y):
    corner_direction = random.choice(["top-left", "top-right", "bottom-left", "bottom-right"])
    corner = [
    [(x, y), (x + 10, y), (x + 20, y), (x, y + 10), (x, y + 20)], #this might be redundant idk
]

    if corner_direction == "top-left":
        corner.extend([(x, y), (x + 10, y), (x, y + 10), (x + 10, y + 10), (x, y + 20)])
    elif corner_direction == "top-right":
        corner.extend([(x, y), (x - 10, y), (x, y + 10), (x - 10, y + 10), (x, y + 20)])
    elif corner_direction == "bottom-left":
        corner.extend([(x, y), (x + 10, y), (x, y - 10), (x + 10, y - 10), (x, y - 20)])
    elif corner_direction == "bottom-right":
        corner.extend([(x, y), (x - 10, y), (x, y - 10), (x - 10, y - 10), (x, y - 20)])
...
def generate_corner_position(x,y):
    while True:
